...
class SaveCommandTest(unittest.TestCase):

    def tearDown(self):
        clean_variables()

    def test_error_when_no_list_found(self):
        cmd = SaveListCommand(
                    parent=None,
                    list="myList",
                    selectors=None,
    ...
    def test_error_when_list_is_not_of_type_list(self):
    ...
    def test_put_with_no_modifiers(self, mock_watchedInsert):
    ...
    @patch('mist.lang.classes.watchedInsert')
    def test_put_with_selectors(self, mock_watchedInsert):
    ...
    @patch('mist.lang.classes.watchedInsert')
    def test_put_with_columns(self, mock_watchedInsert):
    ...
    @patch('mist.lang.classes.watchedInsert')
    def test_put_with_columns_and_selectors(self, mock_watchedInsert):
    ...
    @patch('mist.lang.classes.watchedInsert')
    def test_put_with_selectors_and_values(self, mock_watchedInsert):
    ...
    @patch('mist.lang.classes.watchedInsert')
    def test_put_with_selectors_columns_and_values(self, mock_watchedInsert):
